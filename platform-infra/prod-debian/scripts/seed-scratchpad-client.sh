...
AUTH_SEED_CLIENT_ID="${AUTH_SEED_CLIENT_ID:-scratchpad-app}"
AUTH_SEED_CLIENT_SECRET="${AUTH_SEED_CLIENT_SECRET:-scratchpad-app-client-secret-2026}"

redirect_uri="${SCRATCHPAD_PUBLIC_URL%/}${SCRATCHPAD_PUBLIC_PATH}/auth/callback"
