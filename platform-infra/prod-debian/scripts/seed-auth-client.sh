...
RADIO_PUBLIC_URL="${RADIO_PUBLIC_URL:-http://31.70.85.89}"
RADIO_PUBLIC_PATH="${RADIO_PUBLIC_PATH:-/devradio}"
...
AUTH_SEED_CLIENT_ID="${AUTH_SEED_CLIENT_ID:-radio-app}"
AUTH_SEED_CLIENT_SECRET="${AUTH_SEED_CLIENT_SECRET:-radio-app-client-secret-2026}"

redirect_uri="${RADIO_PUBLIC_URL%/}${RADIO_PUBLIC_PATH}/auth/callback"
