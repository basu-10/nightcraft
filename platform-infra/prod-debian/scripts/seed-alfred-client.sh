...
ALFRED_PUBLIC_URL="${ALFRED_PUBLIC_URL:-http://31.70.85.89}"
ALFRED_PUBLIC_PATH="${ALFRED_PUBLIC_PATH:-/alfred}"
...
AUTH_SEED_CLIENT_ID="${AUTH_SEED_CLIENT_ID:-alfred-app}"
AUTH_SEED_CLIENT_SECRET="${AUTH_SEED_CLIENT_SECRET:-alfred-app-client-secret-2026}"

redirect_uri="${ALFRED_PUBLIC_URL%/}${ALFRED_PUBLIC_PATH}/auth/callback"
