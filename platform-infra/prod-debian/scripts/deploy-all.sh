...
"${SCRIPT_DIR}/deploy-quickposts.sh"
"${SCRIPT_DIR}/deploy-noteflow.sh"
"${SCRIPT_DIR}/deploy-scratchpad.sh"
...
"${SCRIPT_DIR}/seed-quickposts-client.sh"
"${SCRIPT_DIR}/seed-noteflow-client.sh"
"${SCRIPT_DIR}/seed-scratchpad-client.sh"
