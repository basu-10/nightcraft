...
GAME_PUBLIC_URL="${GAME_PUBLIC_URL:-http://31.70.85.89}"
GAME_PUBLIC_PATH="${GAME_PUBLIC_PATH:-/game}"
...
AUTH_SEED_CLIENT_ID="${AUTH_SEED_CLIENT_ID:-game-app}"
AUTH_SEED_CLIENT_SECRET="${AUTH_SEED_CLIENT_SECRET:-game-app-client-secret-2026}"

redirect_uri="${GAME_PUBLIC_URL%/}${GAME_PUBLIC_PATH}/auth/callback"
