...
QUICKPOSTS_SRC_DIR="${QUICKPOSTS_SRC_DIR:-${REPO_ROOT}/app-quickposts}"
QUICKPOSTS_SLUG="${QUICKPOSTS_SLUG:-app-quickposts}"
NOTEFLOW_SRC_DIR="${NOTEFLOW_SRC_DIR:-${REPO_ROOT}/app-noteflow}"
NOTEFLOW_SLUG="${NOTEFLOW_SLUG:-app-noteflow}"
SCRATCHPAD_SRC_DIR="${SCRATCHPAD_SRC_DIR:-${REPO_ROOT}/app-scratchpad}"
SCRATCHPAD_SLUG="${SCRATCHPAD_SLUG:-app-scratchpad}"
...
QUICKPOSTS_SHARED_DIR="${SHARED_ROOT}/${QUICKPOSTS_SLUG}"
NOTEFLOW_SHARED_DIR="${SHARED_ROOT}/${NOTEFLOW_SLUG}"
SCRATCHPAD_SHARED_DIR="${SHARED_ROOT}/${SCRATCHPAD_SLUG}"
...
QUICKPOSTS_VENV_DIR="${QUICKPOSTS_VENV_DIR:-${VENV_ROOT}/${QUICKPOSTS_SLUG}}"
NOTEFLOW_VENV_DIR="${NOTEFLOW_VENV_DIR:-${VENV_ROOT}/${NOTEFLOW_SLUG}}"
SCRATCHPAD_VENV_DIR="${SCRATCHPAD_VENV_DIR:-${VENV_ROOT}/${SCRATCHPAD_SLUG}}"
