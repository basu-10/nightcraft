...
SEEKSAGE_PUBLIC_URL="${SEEKSAGE_PUBLIC_URL:-http://31.70.85.89}"
SEEKSAGE_PUBLIC_PATH="${SEEKSAGE_PUBLIC_PATH:-/seeksage}"
...
AUTH_SEED_CLIENT_ID="${AUTH_SEED_CLIENT_ID:-seeksage-app}"
AUTH_SEED_CLIENT_SECRET="${AUTH_SEED_CLIENT_SECRET:-seeksage-app-client-secret-2026}"

redirect_uri="${SEEKSAGE_PUBLIC_URL%/}${SEEKSAGE_PUBLIC_PATH}/auth/sso/callback"
