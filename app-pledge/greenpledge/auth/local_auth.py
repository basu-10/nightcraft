...
def login():
    ...
    if request.method == "POST":
        ...
        if user and user.role == "member" and user.check_password(password):
    ...
    return render_template("auth/login.html", mode="member")
...
def register():
    ...
    if request.method == "POST":
        ...
        user = LocalCredential(username=username, role="member")
