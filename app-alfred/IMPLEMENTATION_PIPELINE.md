...
- [ ] **1. Gunicorn workers = 1 (deployment invariant)**
...
- [ ] **2. Runtime policies: idle timeout + max runtime (+ token/cost budget)**
...
- [ ] **3. `/touch` authentication (operational security)**
...
- [ ] **4. Evidence enforcement (schema, not promises)**
...
- [ ] **6. LangGraph checkpointer clarification (docs)**
...
- [ ] **7. Reindex without downtime (atomic swap)**
...
- [ ] **8. `workspace_id` — keep nullable/unused**
...
- [ ] **9. Binary edits — explicit product rule**
...
- [ ] **11. Startup health check (fail fast)**
